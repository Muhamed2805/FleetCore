  ...
  for (const vehicle of vehicles ?? []) {
    ...
    if (vehicle.registration_expiry) {
      events.push({
        ...
        type: "registration",
        title: t("events.registrationTitle", { vehicle: vehicleLabel }),
    ...
    if (vehicle.insurance_expiry) {
      events.push({
        ...
        type: "insurance",
        title: t("events.insuranceTitle", { vehicle: vehicleLabel }),
        href: `/dashboard/vehicles/${vehicle.id}`,
      });
    }
    if (vehicle.inspection_expiry) {
      events.push({
        ...
        type: "inspection",
        title: t("events.inspectionTitle", { vehicle: vehicleLabel }),
        href: `/dashboard/vehicles/${vehicle.id}`,
      });
    }
  }
